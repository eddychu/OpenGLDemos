...
from framework.utils.surface import Surface
    ...
    def __init__(self, uStart, uEnd, uResolution, vStart, vEnd, vResolution, surfaceFunction):
        ...
        for xIndex in range(uResolution):
            for yIndex in range(vResolution):
                ...
                vertexPositionData += [pA.copy(), pB.copy(),
                                       pC.copy(), pA.copy(), pC.copy(), pD.copy()]
                ...
                vertexNormalData += [nA.copy(), nB.copy(),
                                     nC.copy(), nA.copy(), nC.copy(), nD.copy()]

        self.addAttribute("vertexPosition",
                          AttributeDataType.VEC3, vertexPositionData)
        self.addAttribute(
            "vertexNormal", AttributeDataType.VEC3, vertexNormalData)
        self.addAttribute("vertexUV", AttributeDataType.VEC2, vertexUVData)
